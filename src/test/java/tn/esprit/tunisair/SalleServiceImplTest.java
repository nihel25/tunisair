...
public class SalleServiceImplTest {
    ...
    void testSaveSalle() {
        ...
        SalleDTO salleDTO = new SalleDTO(30L,"jerba2",200L); // Initialisez avec des valeurs appropriées
...
//        assertEquals(salleDTO, savedSalleDTO);
    ...
    void testRecherch() {
        ...
        assertEquals(expectedSalleDTO.getStatut(), foundSalleDTO.getStatut());
        // Vérifier les résultats
